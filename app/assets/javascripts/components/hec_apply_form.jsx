class HecApplyForm extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    if (this.state.submitting) {
      ...
      submitButton = (
        <input id='apply_btn' type='submit' value='Postulez au Wagon HEC' className='apply-form-submit btn' />
      );
    }
              ...
              <form id='apply' action={this.props.apply_path} method='post' onSubmit={this.onSubmit.bind(this)}>
                ...
                <div className='apply-form-row-submit'>
                  <div className='apply-form-price'>
                    {this.props.i18n.price}: <strong>{this.props.formatted_price}€</strong>
                  </div>
                  {submitButton}
                </div>
              </form>
